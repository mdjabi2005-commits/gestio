...
[Code]
// Verifier si une version precedente est installee et proposer de la desinstaller
...
begin
  ...
  begin
    if MsgBox(
      'Une version precedente de Gestio est installee.' + #13#10 +
      'Voulez-vous la desinstaller avant de continuer ?',
...
// Ouvrir Gestio apres installation si l'utilisateur le souhaite
...
begin
  ...
  begin
    if MsgBox(
      'Installation terminee !' + #13#10#13#10 +
