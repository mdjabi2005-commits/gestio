...
class AttachmentService:
    ...
    def add_attachment(self, transaction_id: int, file_obj, filename: str, category: str, subcategory: str,
    ...
    def move_file_to_category_folder(self, source_path: str, transaction_type: str, category: str, subcategory: str,
    ...
    @staticmethod
    def get_file_content(attachment_id: int) -> Optional[bytes]:
    ...
    @staticmethod
    def _map_row_to_model(row: dict) -> TransactionAttachment:
