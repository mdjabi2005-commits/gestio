...
## Vue d'ensemble
Ce document détaille le flux de données pour l'import de transactions, en précisant pour chaque étape : la fonction responsable, les données en entrée, et les données en sortie.
