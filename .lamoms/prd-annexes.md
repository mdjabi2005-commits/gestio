# PRD annexe — le lot hors cycle

**Émis le 2026-08-11 par le Planificateur.**
...
**Ne remplace pas** `prd-cycle1.archive.md` ni `prd-cycle2.archive.md`. **Ne préempte pas** le PRD 3, qui n'existera qu'après #40.
