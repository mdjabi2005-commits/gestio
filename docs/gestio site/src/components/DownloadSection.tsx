...
const INSTALL_SCRIPT = "curl -sSL https://github.com/mdjabi2005-commits/gestio/releases/download/v1.0.0/install-mac-linux.sh | bash";
          ...
          {platforms.map((p, i) => (
            <Reveal key={p.name} delay={i * 100}>
              <div className="bg-card border border-border rounded-2xl p-10 text-center transition-all hover:-translate-y-2 hover:border-primary hover:shadow-[0_24px_48px_rgba(0,0,0,0.3)] h-full flex flex-col">
                ...
                {p.type === "exe" ? (
                  <a
                    href="https://github.com/mdjabi2005-commits/gestio/releases/download/v1.0.0/Gestio-Setup-v1.0.0.exe"
